...
export function EventStatsCards({ event }: EventStatsCardsProps) {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-4">
      <div className="bg-white rounded-lg border border-dash-border p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-12 w-12 rounded-full bg-dash-highlight flex items-center justify-center">
            <Ticket className="h-6 w-6 text-dash-muted" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-dash-border p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-12 w-12 rounded-full bg-dash-highlight flex items-center justify-center">
            <TrendingUp className="h-6 w-6 text-dash-muted" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-dash-border p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="h-12 w-12 rounded-full bg-dash-highlight flex items-center justify-center">
            <Users className="h-6 w-6 text-dash-muted" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-dash-border p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-dash-ink mt-1">1,247</p>
            <p className="text-xs text-dash-accent mt-1">
              {event.totalTicketsSold > 0
          ...
          <div className="h-12 w-12 rounded-full bg-dash-highlight flex items-center justify-center">
            <Eye className="h-6 w-6 text-dash-muted" />
          </div>
        </div>
      </div>
    </div>
