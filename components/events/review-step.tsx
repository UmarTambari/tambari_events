  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-white border-[#85A947]/20">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-[#123524] flex items-center gap-2">
            <Tag className="h-5 w-5 text-[#85A947]" />
            Basic Information
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div>
            <p className="text-sm text-[#85A947]">Title</p>
            <p className="text-[#123524] font-medium">
              {values.title || "Not set"}
            </p>
          </div>
          <div>
            <p className="text-sm text-[#85A947]">Description</p>
            <p className="text-[#123524] whitespace-pre-wrap">
              {values.description || "Not set"}
            </p>
          </div>
          <div>
            <p className="text-sm text-[#85A947]">Category</p>
            <Badge className="bg-[#EFE3C2] text-[#123524] border-[#85A947]/30">
              {values.category || "Not set"}
            </Badge>
          </div>
          {(values.tags ?? []).length > 0 && (
            <div>
              <p className="text-sm text-[#85A947]">Tags</p>
              <div className="flex flex-wrap gap-2 mt-1">
                {(values.tags ?? []).map((tag) => (
                  <Badge
                    key={tag}
                    variant="outline"
                    className="bg-[#EFE3C2] border-[#85A947]/30 text-[#123524]"
                  >
                    {tag}
                  </Badge>
                ))}
      ...
      <Card className="bg-white border-[#85A947]/20">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-[#123524] flex items-center gap-2">
            <Calendar className="h-5 w-5 text-[#85A947]" />
            Location & Time
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div>
            <p className="text-sm text-[#85A947]">Venue</p>
            <p className="text-[#123524] font-medium flex items-center gap-2">
              <MapPin className="h-4 w-4" />
              {values.venue || "Not set"}
            </p>
          </div>
          <div>
            <p className="text-sm text-[#85A947]">Location</p>
            <p className="text-[#123524]">{values.location || "Not set"}</p>
          </div>
          <div>
            <p className="text-sm text-[#85A947]">Start Date & Time</p>
            <p className="text-[#123524]">{formatDateTime(values.eventDate)}</p>
          </div>
          {values.eventEndDate && (
            <div>
              <p className="text-sm text-[#85A947]">End Date & Time</p>
          ...
          <div>
            <p className="text-sm text-[#85A947]">Capacity</p>
            <p className="text-[#123524]">
          ...
          {values.ticketTypes.length > 0 ? (
            <div className="space-y-4">
              {values.ticketTypes.map((ticket) => (
                <div
                  key={ticket.id}
                  className="p-4 rounded-lg border border-[#85A947]/20 bg-[#EFE3C2]/20"
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-[#85A947]">Quantity:</span>{" "}
                      <span className="text-[#123524] font-medium">
                        {ticket.quantity || "0"}
                      </span>
                    </div>
                    <div>
                      <span className="text-[#85A947]">Max per order:</span>{" "}
                      <span className="text-[#123524] font-medium">
                        {ticket.maxPurchase}
                      </span>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-[#85A947]/20">
                <div>
                  <p className="text-sm text-[#85A947]">Total Tickets</p>
                  <p className="text-2xl font-bold text-[#123524]">
                    {totalTickets}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-[#85A947]">Potential Revenue</p>
                  <p className="text-2xl font-bold text-[#123524]">
            ...
            <p className="text-[#85A947] text-center py-4">
      ...
      <Card className="bg-white border-[#85A947]/20">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-[#123524] flex items-center gap-2">
            <ImageIcon className="h-5 w-5 text-[#85A947]" />
            Images
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <div>
            <p className="text-sm text-[#85A947]">Banner Image</p>
            <p className="text-[#123524]">
              {values.bannerImageUrl ? "Yes Added" : "No banner added"}
            </p>
          </div>
          <div>
            <p className="text-sm text-[#85A947]">Thumbnail Image</p>
            <p className="text-[#123524]">
